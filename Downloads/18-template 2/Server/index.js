...
function main(req, res) {
    ...
    } else if (req.method === 'GET' && pathname === '/task04') {
        
        res.writeHead(200, {
          "Content-type":"text/html; charset=utf-8"
        })
        let s = task04.task(employees);       
        res.end(s)

    } else if (req.method === 'GET' && pathname === '/task05') {
        
      res.writeHead(200, {
        "Content-type":"text/html; charset=utf-8"
      })
      let s = task05.task(employees);       
      res.end(s)

    } else if (req.method === 'GET' && pathname === '/task06') {
        
      res.writeHead(200, {
        "Content-type":"text/html; charset=utf-8"
      })
      let s = task06.task(employees);       
      res.end(s)
